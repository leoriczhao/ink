...
struct Matrix {
  ...
  /// @brief Create a rotation matrix (radians, counter-clockwise around
  /// origin).
  ...
  bool isScaleTranslateOnly() const { return skewX == 0 && skewY == 0; }

  bool operator==(const Matrix &o) const {
    return scaleX == o.scaleX && skewY == o.skewY && skewX == o.skewX &&
           scaleY == o.scaleY && transX == o.transX && transY == o.transY;
  }
