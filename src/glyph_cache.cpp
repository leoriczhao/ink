...
bool GlyphCache::rasterizeGlyph(char ch) {
  ...
  stbtt_MakeCodepointBitmap(info, atlas_.data() + cursorY_ * atlasW_ + cursorX_,
...
void GlyphCache::drawText(u32 *pixels, i32 stride, i32 bufH, i32 x, i32 y,
